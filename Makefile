...
#LDFLAGS = -lzmq -lsnappy -lz -lpthread -lglog -fno-builtin-malloc -fno-builtin-calloc -fno-builtin-realloc -fno-builtin-free -ltcmalloc_minimal  -O3 -m64 -ftree-vectorize -msse4 -fopenmp 
